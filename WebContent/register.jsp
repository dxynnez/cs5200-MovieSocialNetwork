	...
	<form class="forms">
		<fieldset>
			<ol>
				...
				<li class="form-row text-input-row"><label>User Name</label><input type="text" id="username" name="username" value="" class="text-input required" title="" /></li> 
				...
				<li class="button-row"><button name="Submit" value="submit" onclick="createUserSeverlet();">Submit</button></li>
			</ol>
		</fieldset>
	</form>
</div>
