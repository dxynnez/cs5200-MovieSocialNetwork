...
<div class="box">
	...
	<div class="title">
  <h2 id="title"><a itemprop="url" href="/movie/157336-interstellar"><span itemprop="name">Interstellar</span></a></h2> <h3 id="year">(2014)</h3>
</div>	
	<div class="one-half">
     <img src="http://image.tmdb.org/t/p/w500/nBNZadXqJSdt05SHLqgT0HuC5Gm.jpg" />
     <!-- LikeBtn.com BEGIN -->

      <p><span class="dropcap">I</span>nterstellar chronicles the adventures of a group of explorers who make use of a newly discovered wormhole to surpass the limitations on human space travel and conquer the vast distances involved in an interstellar voyage. </p>
