...
function createFollow(){
	...
	var follower=getPara("follower");
	$.ajax({
		url : "/movieProject/api/follow/create/"+username+"&"+follower,
		type:"post",
		dataType: "json",
...
function createMessageSeverlet()
{
	$(function()
	{
		var message =
		{
			"id":1,
			"receiver":getPara("username"),
			"sender":getPara("follower"),
			"message": $("#message").val()
		};
...
window.onload = function(){
	...
	if(username != ""){
		...
		id1.href="index.jsp?username="+getPara("follower");
		id2=document.getElementById("php");
		id2.href="user.jsp?username="+getPara("follower");
		temp=document.getElementById("filter");
		temp.href="SearchByFilter.jsp?username="+getPara("follower");
		temp1=document.getElementById("search");
		temp1.href="search.jsp?username="+getPara("follower");
		$.ajax(
				{
...
//						id1.innerHTML = response.description;
	...
	//					console.log(response);
						...
						for(var i=0; i<response.length;i++){
							...
							$("#movie").append("<li> <div class=\"frame\"> <a href=\"Moviewithcomments.jsp?id="+source+"&username="+getPara("follower")+"\"><img src=\"style/images/art/s1.jpg\"/></a> </div> <div class=\"meta\"> <h6><a id=movie href=\"Moviewithcomments.jsp?id="+source+"&username="+getPara("follower")+"\">"+response[i].name+"</a></h6> </div> </li>");
	...
	<div class="header">
		...
		<div id="menu-wrapper">
			<div id="menu" class="menu">
				<ul id="tiny">
					<li class="active"><a id="php" href="">Personal Homepage</a>
					</li>
...
<div class="content">
		...
		<div class="post format-image box"> 
			...
			<div class="tags" id="followMe"><li class="button-row"><button name="Submit" value="submit" onclick="createFollow();">Follow Me</button></li></div>	
		...
		<div id="comment-form" class="comment-form">
			...
			<div id="respond">
						<h3 id="reply-title">Leave a Message</h3>
							...
							<p class="form-submit">
								<input name="submit" type="submit" id="submit" value="Submit" onclick="createMessageSeverlet();"/>
							</p>
			</div><!-- #respond -->	
